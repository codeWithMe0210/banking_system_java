...
public class MyJDBC {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/tejas";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "tejas";
    ...
    public static boolean register(String username, String password){
        try{
            ...
            if(!checkUser(username)){
                Connection connection = DriverManager.getConnection(DB_URL, DB_USERNAME, DB_PASSWORD);
                String quary="INSERT INTO users(name, password, current_balance) " +
                                "VALUES(?, ?, ?)";
    ...
    public static boolean transfer(User user, String transferredUsername, float transferAmount){
        try{
            Connection connection = DriverManager.getConnection(DB_URL, DB_USERNAME, DB_PASSWORD);
             String quary="SELECT * FROM users WHERE name=?";
            PreparedStatement queryUser = connection.prepareStatement(quary);
