...
public class BankingAppGui extends BaseFrame implements ActionListener {
    ...
    protected void addGuiComponents() {
        ...
        welcomeMessageLabel.setForeground(color.text);
        ...
        currentBalanceLabel.setForeground(color.text);
...
//
        ...
        currentBalanceField.setBackground(color.secondary);
        currentBalanceField.setForeground(color.text);
        ...
        depositButton.setForeground(color.text);
        depositButton.setBackground(color.secondary);
        add(depositButton);
        ...
        withdrawButton.setBackground(color.secondary);
        withdrawButton.setForeground(color.text);
        add(withdrawButton);
        ...
        pastTransactionButton.setBackground(color.secondary);
        pastTransactionButton.setForeground(color.text);
        ...
        transferButton.setBackground(color.secondary);
        transferButton.setForeground(color.text);
        add(transferButton);
        ...
        logoutButton.setBackground(color.secondary);
        logoutButton.setForeground(color.text);
        add(logoutButton);
    }
